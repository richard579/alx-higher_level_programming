...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_width_height_1(self):
        """ Tests for width and height types"""
    ...
    def test_to_dictonary_1(self):
        """Tests to see if to_dictionary method is working"""
    ...
    def test_load_from_file_1(self):
        """ Tests load from file if file is non-existent """
        r1 = Rectangle(1, 1)
        r2 = Rectangle(2, 2)
